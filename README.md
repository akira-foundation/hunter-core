...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/hunter-core.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/hunter-core)
...
```bash
php artisan vendor:publish --tag="hunter-core-migrations"
php artisan migrate
```
...
```bash
php artisan vendor:publish --tag="hunter-core-views"
```
...
```php
$core = new Core\Core();
echo $core->echoPhrase('Hello, Core!');
```
...
- [kid](https://github.com/akira-foundation)
